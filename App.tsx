...
const App = () => {
  ...
  const startRecording = async () => {
    ...
    console.log('Availability: ', await Voice.isAvailable());
    setLoading(true);
    try {
  ...
  useEffect(() => {
    Voice.onSpeechStart = e => console.log('OnSpeech Start : ', e);
    Voice.onSpeechStart = speechStartHandler;
    Voice.onSpeechEnd = speechEndHandler;
    Voice.onSpeechResults = speechResultsHandler;
    Voice.onSpeechRecognized = () => console.log('Speech recognized');
    Voice.onSpeechPartialResults = e => console.log('Partial Result : ', e);
    return () => {
